...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li> <li class="active">Staff</li>
   ...
   <hr><hr>
                ...
                <form id="formval" action="" method="post">
                 ...
                 <div class="form-group col-md-3">
                  ...
                  <input class="form-control" type="text" placeholder="" name="tname" id="tnamae" onblur="" >
                  
                </div>

                <div class="form-group col-md-3">
                  <label class="control-label">Contact No.</label>
                  <input class="form-control" type="text" placeholder="" name="contact" id="contact" onblur="" >
                  
                </div>
   
               <div class="form-group col-md-3">
                  <label class="control-label">teacher ID</label>
                  <input class="form-control" type="text" placeholder="" name="teacherid" id="teacherid" onblur="" >
