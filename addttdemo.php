...
$query1 = mysqli_query($connection,"SELECT class FROM class");
...
<div class="form-group col-md-4">
 ...
 <div class="form-group col-md-12" id="classdiv" style="display: none;">
     ...
     <div class="form-group col-md-4" id="classtea" >
             ...
             <div class="form-group col-md-12" id="labdiv" style="display: none;" >
