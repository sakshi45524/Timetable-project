...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1> Subject </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li> <li class="active">Subject</li>
  ...
  <form id="formval" action="" method="post">
                 ...
                 <div class="form-group col-md-3">
                  ...
                  <input class="form-control" type="text" placeholder="" name="subject" id="subject" onblur="" >
               ...
               <div class="form-group col-md-3">
                  ...
                  <input class="form-control" type="text" placeholder="" name="subjectcode" id="subjectcode" onblur="" >
...
if(isset($_POST['addsub']))
{
 ...
 $query=mysqli_query($connection,"INSERT INTO subject (subject,subjectcode) VALUES('$subject','$subjectcode')");
   if($query)
    {
